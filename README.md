...
- The C++ port has not been re-exported or re-benchmarked since the feature count went from 4 to 9, so its weight headers and the latency figure quoted under `cpp/` are stale until that is redone.
