...
def export_model(prefix, cpp_name):
    ...
    assert list(meta["features"]) == [
        "vertical_speed", "horizontal_speed", "roll_angle", "pitch_angle",
        "vertical_speed_delta", "horizontal_speed_delta", "roll_angle_delta", "pitch_angle_delta",
    ], "feature order changed - update live_inference.cpp's row layout to match"
